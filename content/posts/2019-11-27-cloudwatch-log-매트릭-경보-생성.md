...
[/var/log/messages]  
 datetime\_format = %b %d %H:%M:%S  
 file = /var/log/messages  
 buffer\_duration = 5000  
 log\_stream\_name = test  
 initial\_position = end\_of\_file  
 log\_group\_name = linuxer-blog-WG
...
세개의 옵션이 중요하다. end\_of\_file 은 뒤부터 추가되는 로그를 watch 로 전송한다.
